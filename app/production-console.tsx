...
export default function ProductionConsole() {
  ...
  return <>
    <header className="production-topbar"><a className="wordmark" href="/"><span>NOH</span><i>Reel Forge</i></a><nav aria-label="Production navigation"><a href="/">Studio</a><a href="/edit">Edit lab</a><a href="/cut">Cut log</a><a className="current" href="/production">Production</a><a href="/bots">Bot check</a><a href="/bot-guide">Bot guide</a><a href="/connect">Local desk</a><a href="/export">Export</a></nav><div><span>LOOPBACK ONLY</span><b>127.0.0.1:7214</b></div></header>
