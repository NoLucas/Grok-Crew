...
export default function BotStatusConsole() {
  ...
  return <>
    <header className="bot-topbar"><a className="wordmark" href="/"><span>NOH</span><i>Reel Forge</i></a><nav aria-label="Bot navigation"><a href="/">Studio</a><a href="/cut">Cut log</a><a href="/production">Production</a><a className="current" href="/bots">Bot check</a><a href="/connect">Local desk</a></nav><div><span>LOCAL ACTIVITY</span><b>{summary?.active_now ?? 0} ACTIVE</b></div></header>
