...
export default function ConnectConsole() {
  ...
  return <><header className="forge-header connect-header"><a href="/" className="wordmark"><span>NOH</span><i>Reel Forge</i></a><nav aria-label="Primary navigation"><a href="/">Studio</a><a href="/edit">Edit lab</a><a href="/library">Library</a><a href="/agent">Agent desk</a><a className="current" href="/connect">Local desk</a><a href="/packet">Packet</a><a href="/gates">Gate board</a><a href="/export">Export</a></nav><div className="header-meta"><span>Offline workspace · this device only</span><b>Created with Grok</b></div></header>
