...
- The Windows exe, installer, tray, and desk header use a crew-and-reel mark: three overlapping discs with a vertical slot, on the purple desk tile. It is not a letter and not a copy of other model icons.
