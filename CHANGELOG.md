...
- The Windows exe, installer, tray, and desk header use an orbit-reel mark: a vertical capsule between two crescent arms, on the purple desk tile. It is not a letter, not the earlier three-lobe mark, and not a copy of other model icons.
