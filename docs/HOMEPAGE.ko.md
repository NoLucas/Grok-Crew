...
- `/home`은 `?lang=`이 없을 때 언어 선택을 먼저 연다. 설명 문장 없이 마크와 고유어 이름만 둔다. 네 언어: English / 한국어 / 中文 / 日本語. 브라우저 언어나 예전 선택만으로는 건너뛰지 않는다. 고르면 `?lang=` 과 localStorage `grok-crew-home-lang`에 남고, 헤더에서 다시 바꿀 수 있다
