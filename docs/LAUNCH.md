...
- [x] Write `v1.0.3` notes in `docs/RELEASE_NOTES.v1.0.3.md` and `CHANGELOG.md`. Guest download stays the same Google Drive `GrokCrew-Windows.exe`. The update feed tag is [NoLucas/Grok-crew-test v1.0.3](https://github.com/NoLucas/Grok-crew-test/releases/tag/v1.0.3).
- [x] Write `v1.0.4` notes in `docs/RELEASE_NOTES.v1.0.4.md` and `CHANGELOG.md`. Guest download stays the same Google Drive `GrokCrew-Windows.exe`. The update feed tag is [NoLucas/Grok-crew-test v1.0.4](https://github.com/NoLucas/Grok-crew-test/releases/tag/v1.0.4).
- [x] Write `v1.0.5` notes in `docs/RELEASE_NOTES.v1.0.5.md` and `CHANGELOG.md`. Guest download stays the same Google Drive `GrokCrew-Windows.exe`. The update feed tag is [NoLucas/Grok-crew-test v1.0.5](https://github.com/NoLucas/Grok-crew-test/releases/tag/v1.0.5).
- [x] Write `v1.0.6` notes in `docs/RELEASE_NOTES.v1.0.6.md` and `CHANGELOG.md`. Guest download stays the same Google Drive `GrokCrew-Windows.exe`. The update feed tag is [NoLucas/Grok-crew-test v1.0.6](https://github.com/NoLucas/Grok-crew-test/releases/tag/v1.0.6).
- [x] Write `v1.0.7` notes in `docs/RELEASE_NOTES.v1.0.7.md` and `CHANGELOG.md`. Guest download stays the same Google Drive `GrokCrew-Windows.exe`. The update feed tag is [NoLucas/Grok-crew-test v1.0.7](https://github.com/NoLucas/Grok-crew-test/releases/tag/v1.0.7).
- [x] Write `v1.0.8` notes in `docs/RELEASE_NOTES.v1.0.8.md` and `CHANGELOG.md`. Guest download stays the same Google Drive `GrokCrew-Windows.exe`. The update feed tag and the Windows installer are [NoLucas/Grok-crew-test v1.0.8](https://github.com/NoLucas/Grok-crew-test/releases/tag/v1.0.8). Grok-Crew gets the same notes this once, without the exe.
- [x] Write `v1.0.9` notes in `docs/RELEASE_NOTES.v1.0.9.md` and `CHANGELOG.md`. Guest download stays the same Google Drive `GrokCrew-Windows.exe`. The update feed tag and the Windows installer are [NoLucas/Grok-crew-test v1.0.9](https://github.com/NoLucas/Grok-crew-test/releases/tag/v1.0.9). Grok-Crew gets the same notes, without the exe.
- [x] Write `v1.0.10` notes in `docs/RELEASE_NOTES.v1.0.10.md` and `CHANGELOG.md`. Guest download stays the same Google Drive `GrokCrew-Windows.exe`. The update feed tag and the Windows installer are [NoLucas/Grok-crew-test v1.0.10](https://github.com/NoLucas/Grok-crew-test/releases/tag/v1.0.10). Grok-Crew gets the same notes, without the exe.
- [x] Write `v1.0.11` notes in `docs/RELEASE_NOTES.v1.0.11.md` and `CHANGELOG.md`. Guest download stays the same Google Drive `GrokCrew-Windows.exe`. The update feed tag and the Windows installer are [NoLucas/Grok-crew-test v1.0.11](https://github.com/NoLucas/Grok-crew-test/releases/tag/v1.0.11). Grok-Crew gets the same notes, without the exe.
- [x] Write `v1.0.12` notes in `docs/RELEASE_NOTES.v1.0.12.md` and `CHANGELOG.md`. Guest download stays the same Google Drive `GrokCrew-Windows.exe`. The update feed tag and the Windows installer are [NoLucas/Grok-crew-test v1.0.12](https://github.com/NoLucas/Grok-crew-test/releases/tag/v1.0.12). Grok-Crew gets the same notes, without the exe.
...
- [x] Write `v1.0.17` notes in `docs/RELEASE_NOTES.v1.0.17.md` and `CHANGELOG.md`. Guest download stays the same Google Drive `GrokCrew-Windows.exe`. The update feed tag and the Windows installer are [NoLucas/Grok-crew-test v1.0.17](https://github.com/NoLucas/Grok-crew-test/releases/tag/v1.0.17). The same installer files are also attached on [Grok-Crew v1.0.17](https://github.com/NoLucas/Grok-Crew/releases/tag/v1.0.17).
...
- [x] Write `v1.0.22` notes in `docs/RELEASE_NOTES.v1.0.22.md` and `CHANGELOG.md`. Guest download stays the same Google Drive `GrokCrew-Windows.exe`. The update feed tag and the Windows installer are [NoLucas/Grok-crew-test v1.0.22](https://github.com/NoLucas/Grok-crew-test/releases/tag/v1.0.22). The same installer files are also attached on [Grok-Crew v1.0.22](https://github.com/NoLucas/Grok-Crew/releases/tag/v1.0.22).
...
This repository does not post social copy for you. Guest facts live in `README.md` and `docs/RELEASE_NOTES.v1.0.22.md`.
...
Preferred signing means: Azure Trusted Signing, or an EV certificate. A cheap OV certificate often leaves the blue screen. After secrets exist, Codex may wire the release job so only a signed installer is published as latest. Mac notarize stays false.

Do not paste `.pfx`, certificate passwords, or Azure client secrets into issues, chat, or this repo.
