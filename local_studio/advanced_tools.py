...
Bots must read this catalog (GET /api/v2/tools or GET /api/bot-guide)
instead of scraping the browser HTML of /tools and the older consoles.
"""
...
def _loc(ko: str, en: str, zh: str, ja: str) -> dict[str, str]:
    return {"ko": ko, "en": en, "zh": zh, "ja": ja}
...
_TOOLS: list[dict[str, Any]] = [
    {
        ...
        "url": "/tools",
        "live": False,
        "name": _loc("고급 도구 목록", "Advanced tools index", "高级工具目录", "高度なツール一覧"),
        "detail": _loc(
        ...
        "bot_api": {"read": ["GET /api/v2/tools", "GET /api/bot-guide"], "write": []},
    ...
    },
    {
        ...
        "cli": [
            "python local_studio/grok_crew.py projects list",
            "python local_studio/grok_crew.py jobs render --project {id} --bot-id {bot_id}",
        ],
    },
    {
        "id": "bots",
        "url": "/bots",
        "live": True,
        "name": _loc("봇 확인", "Bot check", "机器人检查", "ボット確認"),
        "detail": _loc(
        ...
        "cli": [
            "python local_studio/grok_crew.py entry --bot-id {bot_id} --display-name {name}",
    ...
    },
    {
        ...
        "url": "/edit",
        "live": False,
        "name": _loc("편집실", "Edit lab", "编辑室", "編集ラボ"),
        "detail": _loc(
        ...
        "bot_api": {"read": ["GET /api/edit-method"], "write": ["POST /api/edit-method"]},
        "cli": [
            "python local_studio/grok_crew.py method get",
            "python local_studio/grok_crew.py method set --file method.json",
        ],
    },
    {
        "id": "cut",
        "url": "/cut",
        "live": False,
        "name": _loc("컷 로그", "Cut log", "剪辑记录", "カットログ"),
        "detail": _loc(
        ...
        "bot_api": {"read": ["GET /api/projects/{id}/operations"], "write": ["POST /api/projects/{id}/cut-map"]},
    ...
    },
    {
        ...
        "url": "/operations",
        "live": False,
        "name": _loc("운영 센터", "Operations", "运营中心", "オペレーション"),
        "detail": _loc(
        ...
        "cli": [
            "python local_studio/grok_crew.py ops show --project {id}",
            "python local_studio/grok_crew.py ops inspect --project {id}",
        ],
    },
    {
        "id": "terminal",
        "url": "/terminal",
        "live": False,
        "name": _loc("터미널", "Terminal", "终端", "ターミナル"),
        "detail": _loc(
        ...
        "bot_api": {"read": ["GET /api/terminal-contract", "GET /downloads/grok-crew.py"], "write": []},
        "cli": [
            "python local_studio/grok_crew.py contract",
            "python local_studio/grok_crew.py site --page tools",
        ],
    },
    {
        "id": "bot-guide",
        "url": "/bot-guide",
        "live": False,
        "name": _loc("봇 설명서", "Bot guide", "机器人指南", "ボットガイド"),
        "detail": _loc(
        ...
        "bot_api": {"read": ["GET /api/bot-guide", "GET /api/v2/tools"], "write": []},
    ...
    },
    {
        ...
        "url": "/library",
        "live": False,
        "name": _loc("라이브러리", "Library", "素材库", "ライブラリ"),
        "detail": _loc(
        ...
        "bot_api": {"read": ["GET /api/v2/handoff/folders"], "write": []},
    ...
    },
    {
        ...
        "url": "/connect",
        "live": False,
        "name": _loc("로컬 도구", "Local tools", "本地工具", "ローカルツール"),
        "detail": _loc(
    ...
    },
    {
        ...
        "url": "/packet",
        "live": False,
        "name": _loc("패킷", "Packet", "数据包", "パケット"),
        "detail": _loc("캡션 패키지 초안입니다.", "A caption-package draft.", "字幕包装草稿。", "キャプション一式の草案です。"),
        "use_when": _loc(
    ...
    },
    {
        ...
        "bot_api": {
            ...
            "write": ["POST /api/projects/{id}/quality-check"],
        },
    ...
    },
    {
        ...
        "url": "/export",
        "live": False,
        "name": _loc("내보내기", "Export", "导出", "エクスポート"),
        "detail": _loc(
        ...
        "bot_api": {"read": ["GET /api/presets"], "write": ["POST /api/projects/{id}/render"]},
        "cli": [
            "python local_studio/grok_crew.py presets",
            "python local_studio/grok_crew.py jobs render --project {id} --bot-id {bot_id}",
        ],
    },
    {
        ...
        "url": "/privacy",
        "live": False,
        "name": _loc("개인정보·설정", "Privacy & settings", "隐私与设置", "プライバシー・設定"),
        "detail": _loc(
            "이 기기 작업 공간 이름을 바꿉니다.",
...
def _pick(value: dict[str, str], language: str) -> str:
...
def advanced_tools_catalog(language: str = "en") -> dict[str, Any]:
        ...
        tools.append(
            {
                ...
                "url": raw["url"],
                "live": raw["live"],
                "name": _pick(raw["name"], lang),
                "detail": _pick(raw["detail"], lang),
                "use_when": _pick(raw["use_when"], lang),
                "never": _pick(raw["never"], lang),
                "bot_api": raw["bot_api"],
                "cli": raw["cli"],
            }
        )
    return {
        ...
        "same_pc_only": True,
        "rule": _pick(_RULE, lang),
        "cli": "python local_studio/grok_crew.py tools [--lang ko]",
        "never": [_pick(item, lang) for item in _NEVER],
        "tools": tools,
    }
