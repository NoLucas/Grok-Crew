...
Open `http://localhost:3000/bot-guide` for the bot-facing editing manual. A local bot can read the same structured guide from `GET /api/bot-guide` before it starts work.
