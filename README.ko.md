...
자세한 목록은 [CHANGELOG.md](CHANGELOG.md)와 [1.0.21 릴리스 노트](docs/RELEASE_NOTES.v1.0.21.md)입니다. 손님용 드라이브 파일은 그대로입니다. 이미 설치한 책상은 Grok-crew-test의 v1.0.21을 봅니다.
