...
1. **Windows 받기**에서 설치하고 엽니다. 계정은 없습니다. 설치 파일은 GitHub Release에서 받습니다.
2. **연결**에서 붙일 글을 복사해 봇 창에 넣습니다. Grok Bot은 등록된 Windows에서 승인 후 체크인하면 붙습니다. 안 되면 봇이 보낸 `GROK_CREW_OK` 한 줄을 여기 붙입니다. 복사만으로는 연결되지 않습니다.
...
자세한 목록은 [CHANGELOG.md](CHANGELOG.md)와 [1.0.3 릴리스 노트](docs/RELEASE_NOTES.v1.0.3.md)입니다.
