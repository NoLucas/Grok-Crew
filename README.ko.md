...
4. **자동**에서 하고 싶은 말을 적고 **만들기**를 누릅니다. 이 창은 기다립니다. **크루 보드**에서 누가 무엇을 했고 다음 자리에 남긴 한 줄을 봅니다.
...
자세한 목록은 [CHANGELOG.md](CHANGELOG.md)와 [1.0.14 릴리스 노트](docs/RELEASE_NOTES.v1.0.14.md)입니다. 손님용 드라이브 파일은 그대로입니다. 이미 설치한 책상은 Grok-crew-test의 v1.0.14를 봅니다.
