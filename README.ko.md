...
3. **연결한다** — **연결 글 복사**를 같은 PC 봇 창에 붙인다. 이 창에 이름이 보이면 연결된 겁니다.
4. **적는다** — 제목.
...
다른 컴퓨터의 AI는 이 화면을 열 수 없습니다. 다른 곳의 봇이 “한번만 보게” 영상을 보내지 않습니다.
